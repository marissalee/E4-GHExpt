...
resps<-datamf[,c(1:4)]
#View(resps)
respnames<-c('Total dry \naboveground biomass (g)','Soil moisture (%)','Nitrate (ugN/G)','Net Nitrification (ugN/G*d)')
shortnames<-c('total','soilmoi','nodi','nitrifd')
resplabels<-c('Total dry \naboveground biomass (g)','Soil moisture (%)',
...
for (i in panelseq){
  ...
  #x-axes
  if (i %in% c(2, 4)) 
  { axis(1, at = 1:4, labels=c('Unplanted','Microstegium','Panicum','Sorghum'), las=2)
#    text(1:4, par("usr")[3] - 0.25, srt = 45, adj = c(1,1),
#         labels = labels, xpd = TRUE)
    mtext("Plant species", side = 1, outer = F, cex = 1, adj= 0.55, line=6)
  }
  #y-axes
  axis(2, at = yat[[i]])
...
*LM model summary and tukey results*... need to see if I can make this prettier
```{r, echo=FALSE}
...
#3. MIXED COMMUNITY POTS - SUPPLEMENTAL

*Plot of mvabund v mvtrt, mvrelabund v mvtrt*, Not included in the ms
```{r, echo=FALSE}
...
*Plot of ammonium, nitrate, total inorganic N*, Not included in the ms
```{r echo=FALSE}
par(mfrow = c(3, 2)) #number of panels
par(cex = 0.8) #font size
...
*Plot of ammonification, nitrification, mineralization*, Not included in the ms
```{r, echo=FALSE}
par(mfrow = c(3, 2)) #number of panels
par(cex = 0.8) #font size
par(mar = c(0, 0, 0, 0), oma = c(5, 5, 0.5, 8)) #size of inner, outer margins 
...
*Plot of ammonium, total inorganic N, ammonification, mineralization*, Not included in the ms
```{r, echo=FALSE}
